    ...
    public class ApplicationDbContext : IdentityDbContext<IdentityUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Device>().HasData(new Device()
            {
                ...
                Description =
                    "6-го поколения, 12.9 IPS, 120 Гц (2732x2048), iOS, Apple M2, ОЗУ 8 Гб, флэш-память 128 ГБ, цвет серебристый",
            ...
            modelBuilder.Entity<Device>().HasData(new Device()
            {
                ...
                Description =
                    "14.2 3024 x 1964, IPS, 120 Гц, Apple M1 Pro (8 ядер), 16 ГБ, SSD 512 ГБ, видеокарта встроенная, Mac OS, цвет крышки серебристый, аккумулятор 70 Вт·ч",
            ...
            modelBuilder.Entity<Device>().HasData(new Device()
            {
                ...
                Description =
                    "5-го поколения, 10.9 IPS (2360x1640), iOS, Apple M1, ОЗУ 8 Гб, флэш-память 64 ГБ, цвет темно-серый",
